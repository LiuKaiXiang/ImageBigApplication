...
/**
 * 基类的View视图 name: MultiStateView <BR>
...
public class MultiStateView extends FrameLayout {
    ...
    /*
     * All of the addView methods have been overridden so that it can obtain the content view via XML It is NOT
     * recommended to add views into MultiStateView via the addView methods, but rather use any of the setViewForState
     * methods to set views for their given ViewState accordingly
     */
    @Override
     ...
     * {@link com.android.threemotherclient.widget.load.MultiStateView.ViewState}
     *
     * @param state The {@link com.android.threemotherclient.widget.load.MultiStateView.ViewState} with to return the
     *              view for
     * @return The {@link View} associated with the
     * {@link com.android.threemotherclient.widget.load.MultiStateView.ViewState}, null if no view is present
     */
    @Nullable
    ...
    /**
     * Returns the current {@link com.android.threemotherclient.widget.load.MultiStateView.ViewState}
     *
     * @return
     */
    ...
    /**
     * Sets the current {@link com.android.threemotherclient.widget.load.MultiStateView.ViewState}
     *
     * @param state The {@link com.android.threemotherclient.widget.load.MultiStateView.ViewState} to set
    ...
    /**
     * Shows the {@link View} based on the {@link com.android.threemotherclient.widget.load.MultiStateView.ViewState}
     */
     ...
     * @param state         The {@link com.android.threemotherclient.widget.load.MultiStateView.ViewState}to set
     * @param switchToState If the {@link com.android.threemotherclient.widget.load.MultiStateView.ViewState} should be
     *                      switched to
     */
    ...
    /**
     * Sets the {@link View} for the given {@link com.android.threemotherclient.widget.load.MultiStateView.ViewState}
     *
     * @param view  The {@link View} to use
     * @param state The {@link com.android.threemotherclient.widget.load.MultiStateView.ViewState} to set
     */
