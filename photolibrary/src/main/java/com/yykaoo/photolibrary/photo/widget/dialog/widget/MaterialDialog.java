...
public class MaterialDialog extends BaseAlertDialog<MaterialDialog> {
    ...
    public void setUiBeforShow() {
        ...
        tv_btn_left.setBackgroundDrawable(ViewUtil.btnSelector(radius, bgColor, btnPressColor, -2));
        tv_btn_right.setBackgroundDrawable(ViewUtil.btnSelector(radius, bgColor, btnPressColor, -2));
        tv_btn_middle.setBackgroundDrawable(ViewUtil.btnSelector(radius, bgColor, btnPressColor, -2));
    }
}
