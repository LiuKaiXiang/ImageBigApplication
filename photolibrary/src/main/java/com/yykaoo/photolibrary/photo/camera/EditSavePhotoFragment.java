...
public class EditSavePhotoFragment extends Fragment {
    ...
    public static ImageButton save_photo;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.photo_frag_edit_save_photo, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        save_photo = (ImageButton) view.findViewById(R.id.save_photo);
