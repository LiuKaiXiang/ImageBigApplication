...
public class ViewUtil {
    ...
    /**
     * 获取属性动画 Method name: getLayoutTransition <BR>
     * Description: getLayoutTransition <BR>
     *
     * @return LayoutTransition<BR>
     */
    public static LayoutTransition getLayoutTransition() {
        LayoutTransition mTransition = new LayoutTransition();
        mTransition.setAnimator(LayoutTransition.CHANGE_APPEARING, (true ? mTransition.getAnimator(LayoutTransition.CHANGE_APPEARING) : null));
        mTransition.setAnimator(LayoutTransition.DISAPPEARING, (true ? mTransition.getAnimator(LayoutTransition.DISAPPEARING) : null));
        mTransition.setAnimator(LayoutTransition.CHANGE_DISAPPEARING, (true ? mTransition.getAnimator(LayoutTransition.CHANGE_DISAPPEARING) : null));
        return mTransition;
    }
