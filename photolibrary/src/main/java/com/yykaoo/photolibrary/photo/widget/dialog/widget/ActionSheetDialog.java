...
import com.yykaoo.photolibrary.photo.widget.dialog.widget.base.BottomBaseDialog;
...
public class ActionSheetDialog extends BottomBaseDialog {
    ...
    private void init() {
        ...
        TranslateAnimation animation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0f, Animation.RELATIVE_TO_SELF, 0f,
                Animation.RELATIVE_TO_SELF, 6f, Animation.RELATIVE_TO_SELF, 0);
    ...
    public void setUiBeforShow() {
        ...
        tv_cancel.setBackgroundDrawable(ViewUtil.listItemSelector(radius, lvBgColor, itemPressColor, 1, 0));
