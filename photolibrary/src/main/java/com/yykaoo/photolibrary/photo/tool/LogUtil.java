...
public class LogUtil {
    ...
    private final static String TAG = LogUtil.class.getCanonicalName();
    ...
    private static final String getLogFolder() {
        File cacheFolder = ToolsUtil.getApplicationContext().getExternalCacheDir();
        String logFolder = cacheFolder.getAbsolutePath() + File.separator + "yykao" + File.separator + "log";
        return logFolder;
    }
