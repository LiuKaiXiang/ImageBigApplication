...
import com.yykaoo.photolibrary.photo.widget.dialog.widget.internal.BaseAlertDialog;
...
public class NormalDialog extends BaseAlertDialog<NormalDialog> {
    ...
    public void setUiBeforShow() {
        ...
        ll_container.setBackgroundDrawable(ViewUtil.cornerDrawable(bgColor, radius));
        tv_btn_left.setBackgroundDrawable(ViewUtil.btnSelector(radius, bgColor, btnPressColor, 0));
        tv_btn_right.setBackgroundDrawable(ViewUtil.btnSelector(radius, bgColor, btnPressColor, 1));
        tv_btn_middle.setBackgroundDrawable(ViewUtil.btnSelector(btnNum == 1 ? radius : 0, bgColor, btnPressColor, -1));
    }
