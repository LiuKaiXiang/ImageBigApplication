package com.yykaoo.photolibrary.photo.widget.dialog.widget.internal;
...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog {
    ...
    /**
     * method execute order: show:constrouctor---show---oncreate---onStart---onAttachToWindow
    ...
    /**
     * set btn text(设置按钮文字内容) btnTexts size 1, middle btnTexts size 2, left right btnTexts size 3, left right middle
     */
    ...
    /**
     * set btn textcolor(设置按钮字体颜色) btnTextColors size 1, middle btnTextColors size 2, left right btnTextColors size 3,
     * left right middle
     */
    ...
    /**
     * set btn textsize(设置字体大小,单位sp) btnTextSizes size 1, middle btnTextSizes size 2, left right btnTextSizes size 3,
     * left right middle
     */
    ...
    /**
     * set btn click listener(设置按钮监听事件) onBtnClickLs size 1, middle onBtnClickLs size 2, left right onBtnClickLs size 3,
     * left right middle
     */
